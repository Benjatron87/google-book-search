...
function Card (props) {
    ...
    return (
        <div className="container">
            <div className="book">
                    <p className="header">{props.title}<button className="buttons">{props.button}</button><button className="buttons" ><a className="link" href={props.link} target="blank">View</a></button></p>
